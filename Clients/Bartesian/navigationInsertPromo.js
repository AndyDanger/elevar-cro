...
let variant1 = () => {
    ...
    let navigationInsertPromoInterval = setInterval(() => {
        ...
        promoColumnLink.href = `https://bartesian.com/products/cocktail-maker`
        promoColumnLink.className = `promoColumnLink submenu__columns one--fourth`
        promoColumnLink.innerHTML =
            `
            <img src="https://i.imgur.com/t97HUPU.png">
        `
        cocktailsLink.parentElement.querySelector(`.header__submenu--container .submenu__columns:nth-child(2)`).remove()
