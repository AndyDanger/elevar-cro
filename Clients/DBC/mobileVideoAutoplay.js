let mobileVideoInterval = setInterval(() => {
    ...
    hero.innerHTML = `<div class="overlay"></div><video autoplay loop muted playsinline id="mobileVideo" src="https://cdn.shopify.com/videos/c/o/v/ec807e8401a24dfdb9ac844ea6056c77.mp4"></video>`
