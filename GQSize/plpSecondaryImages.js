...
let plpSecondaryImages = setInterval(function () {
    let productWraps = document.querySelectorAll('.shg-product') // get product cards
    ...
    productWraps.forEach(function (productWrap) {
        ...
        request.done(function () {
            ...
            let imageWrapper = productWrap.querySelector('.shg-product-image-wrapper') // get the element currently wrapping the image
